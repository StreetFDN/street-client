 ...
 */
router.get('/clients/:clientId/installations', requireAuth, async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/installations/:installationId/sync', requireAuth, async (req: Request, res: Response) => {
  try {
