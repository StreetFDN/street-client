...
//== Event header
export const SupportedEventTypesSchema = z.enum([
  'installation',
...
export const EventHeaderSchema = z
  .object({
    ...
    'x-github-event': z.union([SupportedEventTypesSchema, z.string()]),
  })
  .loose();
...
const PullRequestLabelSchema = z
  .object({
    name: z.string(),
  })
  .loose();
...
export const PullRequestEventSchema = z
  .object({
    action: z.union([z.literal('closed'), z.string()]),
...
//== Installation Events
const CreatedInstallationEventSchema = z
  .object({
...
const DeletedInstallationEventSchema = z
  .object({
...
export type CreatedInstallationEvent = z.infer<
  typeof CreatedInstallationEventSchema
>;
export type DeletedInstallationEvent = z.infer<
  typeof DeletedInstallationEventSchema
>;
export type SupportedInstallationAction = InstallationEvent['action'];

//== Installation Repositories Events
const AddedInstallationRepositoriesEventSchema = z
  .object({
...
const RemovedInstallationRepositoriesEventSchema = z
  .object({
...
export const InstallationRepositoriesEventSchema = z.discriminatedUnion(
  'action',
  [
...
>;
export type AddedInstallationRepositoriesEvent = z.infer<
  typeof AddedInstallationRepositoriesEventSchema
>;
export type RemovedInstallationRepositoriesEvent = z.infer<
  typeof RemovedInstallationRepositoriesEventSchema
>;
export type SupportedInstallationRepositoriesAction =
...
export const ReleaseEventSchema = z
  .object({
    action: z.union([SupportedReleaseActionsSchema, z.string()]),
...
export type SupportedReleaseAction = z.infer<
  typeof SupportedReleaseActionsSchema
>;
